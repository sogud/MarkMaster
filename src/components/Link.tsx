...
const Link: React.FC<LinkProps> = ({ data, viewMode }) => {
  ...
  useEffect(() => {
    const getFavicon = async () => {
      try {
        const response = await fetch(`https://www.google.com/s2/favicons?domain=${data.url}&sz=128`);
    ...
    <div className={viewMode === 'grid' 
      ...
      >
        ...
        <a
          ...
          className={`block relative z-10 ${viewMode === 'grid' 
          ...
          {viewMode === 'grid' ? (
            <>
              <img
                ...
                src={faviconUrl || `https://www.google.com/s2/favicons?domain=${data.url}&sz=128`}
                alt=""
                draggable={false}
              />
